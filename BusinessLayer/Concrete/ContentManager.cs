...
namespace BusinessLayer.Concrete
{
    public class ContentManager : IContentService
    {
        ...
        {
           _contentDal.Insert(content);//Ekleme komutu
        }
        ...
        public List<Content> GetListByHeadingId(int id)//Id'ye göre tüm içerikleri getirme.
        {
            return _contentDal.List(x=>x.HeadingId == id);//istenilen Id'ye göre Başlıkları listeleme işlemi  
        }
